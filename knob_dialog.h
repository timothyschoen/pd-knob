...
"\n"
"array set ::dialog_knob::var_width {} ;\n"
"array set ::dialog_knob::var_minwidth {} ;\n"
"\n"
...
"array set ::dialog_knob::var_arc_width {} ;\n"
"array set ::dialog_knob::var_start_angle {} ;\n"
"array set ::dialog_knob::var_end_angle {} ;\n"
...
"                $::dialog_knob::var_arc_width($vid) \\\n"
"                $::dialog_knob::var_start_angle($vid) \\\n"
"                $::dialog_knob::var_end_angle($vid) \\\n"
"            ]\n"
"}\n"
"\n"
"\n"
...
"\n"
"    set ::dialog_knob::var_width($vid) $wdt\n"
"    set ::dialog_knob::var_minwidth($vid) $min_wdt\n"
"\n"
...
"    set ::dialog_knob::var_arc_width($vid) $arc_width\n"
"    set ::dialog_knob::var_start_angle($vid) $start_angle\n"
"    set ::dialog_knob::var_end_angle($vid) $end_angle\n"
"\n"
...
"    label $mytoplevel.dim.w_lab -text \"Size:\"\n"
"    entry $mytoplevel.dim.w_ent -textvariable ::dialog_knob::var_width($vid) -width 4\n"
...
"    entry $mytoplevel.rng.logmode.expmode_entry -width 3 \n" //-textvariable
...
"    entry $mytoplevel.para.std.num.ent -textvariable ::dialog_knob::var_number($vid) -width 4\n"
"    pack $mytoplevel.para.std.num.ent -side right -anchor e\n"
"\n"
"    set applycmd \"\"\n"
...
"    entry $mytoplevel.para.std.initial_ent -textvariable ::dialog_knob::var_initial($vid) -width 5\n"
...
"    ::dialog_knob::popupmenu_strval $mytoplevel.para.std.move_mode \\\n"
"        ::dialog_knob::var_circular($vid) \\\n"
...
"    checkbutton $mytoplevel.para.knobstyle.arc.ent -variable ::dialog_knob::var_arc_width($vid) -width 5\n"
...
"    entry $mytoplevel.para.knobstyle.start.ent -textvariable ::dialog_knob::var_start_angle($vid) -width 5\n"
...
"    entry $mytoplevel.para.knobstyle.end.ent -textvariable ::dialog_knob::var_end_angle($vid) -width 5\n"
...
"    grid $mytoplevel.para.knobstyle.discrete -row 2 -column 0 -sticky e -padx {20 0}\n"
"\n"
...
"\n"
"        # call apply on Return in entry boxes that are in focus & rebind Return to ok button\n"
"        bind $mytoplevel.dim.w_ent <KeyPress-Return> \"::dialog_knob::apply_and_rebind_return $mytoplevel\"\n"
...
"        bind $mytoplevel.para.std.num.ent <KeyPress-Return> \"::dialog_knob::apply_and_rebind_return $mytoplevel\"\n"
...
"\n"
"        # unbind Return from ok button when an entry takes focus\n"
"        $mytoplevel.dim.w_ent config -validate focusin -vcmd \"::dialog_knob::unbind_return $mytoplevel\"\n"
...
"        $mytoplevel.para.std.num.ent config -validate focusin -vcmd \"::dialog_knob::unbind_return $mytoplevel\"\n"
