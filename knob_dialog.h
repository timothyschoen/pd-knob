...
"                                       bcol fcol acol \\\n"
"                                       discrete ticks \\\n"
"                                       arc_width start_angle end_angle outline} {\n"
...
// Align items to grid
"    grid $mytoplevel.para.knobstyle.dim -row 0 -column 1 -sticky e -padx {5 0}\n"
"    grid $mytoplevel.para.knobstyle.initial -row 1 -column 1 -sticky e -padx {5 0}\n"
"    grid $mytoplevel.para.knobstyle.outline -row 1 -column 1 -sticky e -padx {5 0}\n"
"    grid $mytoplevel.para.knobstyle.move -row 0 -column 0 -sticky e -padx {5 0} \n"
"    grid $mytoplevel.para.knobstyle.arc -row 1 -column 0 -sticky e -padx {5 0}\n"
