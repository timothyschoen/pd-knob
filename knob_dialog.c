...
"                $::dialog_iemgui_knob::var_color_arc($vid) \\\n"
...
"\n"
"array set ::dialog_iemgui_knob::var_color_arc {} ;\n"
...
"\n"
"proc ::dialog_iemgui_knob::preset_col {mytoplevel presetcol} {\n"
"    set vid [string trimleft $mytoplevel .]\n"
"\n"
"    if { $::dialog_iemgui::var_colortype($vid) == 3 } {\n"
"        set ::dialog_iemgui_knob::var_color_arc($vid) $presetcol\n"
"    }\n"
"}\n"
"\n"
"proc ::dialog_iemgui_knob::choose_col {mytoplevel} {\n"
"    set vid [string trimleft $mytoplevel .]\n"
"\n"
"    if {$::dialog_iemgui::var_colortype($vid) == 3} {\n"
"        set helpstring [tk_chooseColor -title [_ \"Arc color\"] -initialcolor $::dialog_iemgui_knob::var_color_arc($vid)]\n"
"        if { $helpstring ne \"\" } {\n"
"            set ::dialog_iemgui_knob::var_color_arc($vid) $helpstring\n"
"        }\n"
"    }\n"
"}\n"
"\n"
...
"}\n"
"\n"
"proc ::dialog_iemgui_knob::create_properties {mytoplevel current_font ticks arc_color arc_width \\\n"
"        start_angle end_angle} {\n"
"    set vid [string trimleft $mytoplevel .]\n"
"\n"
"    set ::dialog_iemgui_knob::var_ticks($vid) $ticks\n"
"    set ::dialog_iemgui_knob::var_color_arc($vid) $arc_color\n"
...
"    entry $mytoplevel.para.knobstyle.arc.ent -textvariable ::dialog_iemgui_knob::var_arc_width($vid) -width 5\n"
...
"\n"
"    # arc color\n"
"    radiobutton $mytoplevel.colors.select.radio2 -value 3 -variable \\\n"
"        ::dialog_iemgui::var_colortype($vid) -text [_ \"Arc?\"] -justify left\n"
"    pack $mytoplevel.colors.select.radio2 $mytoplevel.colors.select.radio1 -side left\n"
"\n"
...
"        -foreground $::dialog_iemgui_knob::var_color_arc($vid) \\\n"
"        -activeforeground $::dialog_iemgui_knob::var_color_arc($vid) \\\n"
...
"        $mytoplevel.para.knobstyle.arc.ent config -validate focusin -vcmd \"::dialog_iemgui::unbind_return $mytoplevel\"\n"
...
"    set ::dialog_iemgui_knob::var_arc_width($vid) \\\n"
"        [::dialog_iemgui::clip $::dialog_iemgui_knob::var_arc_width($vid) $min_arc_width $max_arc_width]\n"
"\n"
"    return [list $::dialog_iemgui_knob::var_ticks($vid) \\\n"
"        $::dialog_iemgui_knob::var_color_arc($vid) $::dialog_iemgui_knob::var_arc_width($vid) \\\n"
