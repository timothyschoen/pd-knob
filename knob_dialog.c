...
"                $::dialog_iemgui_knb::var_ticks($vid) \\\n"
"                $::dialog_iemgui_knb::var_color_arc($vid) \\\n"
"                $::dialog_iemgui_knb::var_arc_width($vid) \\\n"
"                $::dialog_iemgui_knb::var_start_angle($vid) \\\n"
"                $::dialog_iemgui_knb::var_end_angle($vid) \\\n"
"                 \\\n"
"            ]\n"
...
"    label $mytoplevel.para.knbstyle.start.lab -text [_ \"Angular range: \"]\n"
...
"    label $mytoplevel.para.knbstyle.end.lab -text [_ \"Offset: \"]\n"
...
"    pack $mytoplevel.colors.select.radio3 $mytoplevel.colors.select.radio1 -side left\n"
"\n"
